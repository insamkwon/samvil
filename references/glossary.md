...
| Stage gate (§3.⑥) | **`gate`** | 9 named gates: `interview_to_seed`, `seed_to_council`, `council_to_design`, `design_to_scaffold`, `scaffold_to_build`, `build_to_qa`, `qa_to_evolve`, `qa_to_deploy`, `any_to_retro` |
