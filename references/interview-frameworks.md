...
| Tier | 질문 수 | ambiguity 임계값 | 필수 phase |
|---|---|---|---|
| minimal | 3~4 | ≤ 0.10 | Core + Scope (Phase 1+2) |
| standard | 5~6 | ≤ 0.05 | Core + Scope + Lifecycle (8Q) |
| thorough | 6~8 | ≤ 0.02 | + Phase 2.5 (Unknown) + Non-functional + Inversion |
| full | 8+ | ≤ 0.01 | + Stakeholder/JTBD + PATH 4 Research |
| **deep** | **10+** | **≤ 0.005** | **full + Domain pack 25~30Q + premortem 심화** |
