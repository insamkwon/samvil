# SAMVIL AGENTS.md Section (OpenCode)

Copy this section into your project's AGENTS.md file.
SAMVIL MCP server must be running (stdio) for these to work.
...
The pipeline stages are: Interview → Seed → Design → Scaffold → Build → QA → Deploy → Evolve → Retro
