...
def _checks(status: str = "pass") -> list[dict]:
    return [
        {"name": "phase30_final_e2e_bundle", "status": status, "command": "phase30"},
        ...
        {"name": "phase25_evolve_apply", "status": status, "command": "phase25"},
        {"name": "phase24_evolve_proposal", "status": status, "command": "phase24"},
        {"name": "phase23_evolve_intake_context", "status": status, "command": "phase23"},
        {"name": "phase22_qa_recovery_routing", "status": status, "command": "phase22"},
        {"name": "phase21_qa_convergence_gate", "status": status, "command": "phase21"},
        {"name": "phase20_qa_materialization", "status": status, "command": "phase20"},
        {"name": "phase19_qa_synthesis_gate", "status": status, "command": "phase19"},
...
def test_release_report_normalizes_missing_required_checks(tmp_path):
    ...
    assert report["summary"]["missing_checks"] == 17
    assert report["next_action"] == "run release check: phase30_final_e2e_bundle"
