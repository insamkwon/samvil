---
name: samvil-evolve-legacy
description: "[LEGACY] Verbose Korean prose for samvil-evolve. Reference only. Active skill is samvil-evolve (ultra-thin)."
---

# SAMVIL Evolve — Seed Evolution Loop (LEGACY reference)

> Migrated to ultra-thin in T4.2 (Phase B). This file is kept for full
> Wonder/Reflect prose, 5-Gate validation rationale, AC tree mutation rules, and
> autonomous-mode policy. Active skill: `SKILL.md` (≤150 LOC). Do not register
> this file as a runnable skill — frontmatter renamed to `samvil-evolve-legacy`
> on purpose.
