...
| Line | Section |
|---:|---|
| 108 | Boot Sequence (INV-1) |
| 124 | &nbsp;&nbsp;↳ Seed 없는 경우 (Brownfield QA) |
| 147 | Incremental QA — 변경된 Feature만 재검증 |
| 149 | &nbsp;&nbsp;↳ QA 결과 캐시 (.samvil/qa-results.json) |
| 183 | &nbsp;&nbsp;↳ 증분 QA 실행 로직 |
| 205 | &nbsp;&nbsp;↳ 증분 QA 출력 |
| 223 | &nbsp;&nbsp;↳ 전체 재검증 (--full-qa) |
| 237 | &nbsp;&nbsp;↳ QA 결과 갱신 |
| 245 | Pre-QA Contract Layer (v3.2.0, ④+⑤) |
| 284 | Pass 1: Mechanical Verification |
| 286 | &nbsp;&nbsp;↳ web-app |
| 301 | &nbsp;&nbsp;↳ automation |
| 333 | &nbsp;&nbsp;↳ Pass 1b (automation-specific): API Connectivity Check (v3.1.0, v3-027) |
| 414 | &nbsp;&nbsp;↳ game |
| 431 | &nbsp;&nbsp;↳ mobile-app |
| 447 | Pass 1b: Playwright Smoke Run (빌드 통과 후) |
| 449 | &nbsp;&nbsp;↳ web-app |
| 457 | &nbsp;&nbsp;↳ Playwright 설치 확인 (최초 1회) |
| 462 | &nbsp;&nbsp;↳ 증거 디렉토리 준비 |
| 467 | &nbsp;&nbsp;↳ Playwright MCP 연결 안정화 |
| 485 | &nbsp;&nbsp;↳ Smoke Test 실행 |
| 529 | &nbsp;&nbsp;↳ automation |
| 553 | &nbsp;&nbsp;↳ game |
| 595 | &nbsp;&nbsp;↳ mobile-app |
| 626 | &nbsp;&nbsp;↳ dashboard |
| 657 | QA Execution Mode by Tier |
| 661 | &nbsp;&nbsp;↳ `minimal` — Inline QA (unchanged) |
| 665 | &nbsp;&nbsp;↳ `standard` / `thorough` / `full` — Independent Evidence |
| 684 | &nbsp;&nbsp;↳ Spawn Pass 2 Independent Agent |
| 714 | &nbsp;&nbsp;↳ Spawn Pass 3 Independent Agent |
| 740 | &nbsp;&nbsp;↳ Central Synthesis Rules |
| 781 | Pass 2: Functional Verification (Runtime-first) |
| 783 | &nbsp;&nbsp;↳ Pass 2 Tree Setup (v3.0.0+) |
| 845 | &nbsp;&nbsp;↳ web-app |
| 852 | &nbsp;&nbsp;↳ Runtime Verification with Playwright MCP |
| 884 | &nbsp;&nbsp;↳ Pass 2-A: 렌더링 검증 |
| 907 | &nbsp;&nbsp;↳ Pass 2-B: 상호작용 검증 |
| 929 | &nbsp;&nbsp;↳ Pass 2-C: 반응형 검증 |
| 969 | &nbsp;&nbsp;↳ Fallback to Static Analysis |
| 988 | &nbsp;&nbsp;↳ Stop Dev Server |
| 995 | &nbsp;&nbsp;↳ game — Functional Verification |
| 1061 | &nbsp;&nbsp;↳ Fallback for game |
| 1068 | &nbsp;&nbsp;↳ mobile-app — Functional Verification |
| 1117 | &nbsp;&nbsp;↳ dashboard — Functional Verification |
| 1164 | &nbsp;&nbsp;↳ automation — Functional Verification |
| 1217 | &nbsp;&nbsp;↳ Verdict |
| 1242 | Pass 2.5: Semantic Verification (v2.5.0, Reward Hacking Detection) |
| 1246 | &nbsp;&nbsp;↳ 프로세스 |
| 1288 | &nbsp;&nbsp;↳ Pass 2.5 리포트 포맷 |
| 1310 | &nbsp;&nbsp;↳ Verification Questions in Checklist Items (v2.6.0+) |
| 1336 | &nbsp;&nbsp;↳ Fallback (INV-5) |
| 1343 | &nbsp;&nbsp;↳ Per-AC Checklist Aggregation (#08) |
| 1360 | Pass 3: Quality Verification (minimal inline path) |
| 1362 | &nbsp;&nbsp;↳ web-app |
| 1373 | &nbsp;&nbsp;↳ Pass 3 스크린샷 증거 |
| 1389 | &nbsp;&nbsp;↳ game — Quality Verification |
| 1415 | &nbsp;&nbsp;↳ dashboard — Quality Verification |
| 1431 | &nbsp;&nbsp;↳ mobile-app — Quality Verification |
| 1447 | &nbsp;&nbsp;↳ automation — Quality Verification |
| 1463 | Verdict |
| 1487 | Post-QA Contract Layer (v3.2.0, ①+⑥+⑨) |
| 1545 | Event Log (MCP 필수) |
| 1568 | Ralph Loop (if REVISE) |
| 1625 | On PASS — Offer Evolve or Chain to Retro (INV-4) |
| 1674 | &nbsp;&nbsp;↳ Handoff Write |
| 1713 | Pass 1: Mechanical |
| 1716 | Pass 1b: Smoke Run |
| 1721 | Pass 2: Functional (Runtime) |
| 1722 | &nbsp;&nbsp;↳ Verification Method: Playwright / Static (제한적 검증) |
| 1728 | &nbsp;&nbsp;↳ Rendering Verification (Pass 2-A) |
| 1733 | &nbsp;&nbsp;↳ Interaction Verification (Pass 2-B) |
| 1738 | &nbsp;&nbsp;↳ Responsive Verification (Pass 2-C) |
| 1743 | Pass 3: Quality |
| 1752 | Evidence |
| 1756 | Overall: PASS / REVISE / FAIL |
