---
name: samvil-analyze-legacy
description: "[LEGACY] Verbose Korean prose for samvil-analyze. Reference only. Active skill is samvil-analyze (ultra-thin)."
---

# SAMVIL Analyze — 기존 프로젝트 코드 분석 (LEGACY reference)

> Migrated to ultra-thin in T4.4 (Phase B). This file is kept for full
> framework-detection grep recipes, code-quality scan patterns, dependency
> impact analysis, integration-point heuristics, and the original reverse-seed
> JSON shape. Active skill: `SKILL.md` (≤150 LOC). Do not register this file
> as a runnable skill — frontmatter renamed to `samvil-analyze-legacy` on
> purpose.
