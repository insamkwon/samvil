---
name: samvil-interview-legacy
description: "[LEGACY] Verbose Korean prose for samvil-interview. Reference only. Active skill is samvil-interview (ultra-thin)."
---

# SAMVIL Interview — Socratic Requirement Clarification (LEGACY reference)

> Migrated to ultra-thin in T4.6 (Phase C). This file is kept for the
> full Korean phase prompts (Phase 0–4), preset matching prose, 5-path
> question routing tables, Tier-by-Tier rule tables, and per-solution_type
> question bodies. Active skill: `SKILL.md` (≤180 LOC). Do not register
> this file as a runnable skill — frontmatter renamed to
> `samvil-interview-legacy` on purpose.
