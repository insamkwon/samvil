...
| Line | Section |
|---:|---|
| 50 | Boot Sequence (INV-1) |
| 63 | Process |
| 65 | &nbsp;&nbsp;↳ Step 0: 기존 프로젝트 감지 및 캐시 확인 |
| 139 | &nbsp;&nbsp;↳ Step 0.5: Load Pinned Versions (Determinism) |
| 145 | &nbsp;&nbsp;↳ Step 1: Determine Stack |
| 185 | &nbsp;&nbsp;↳ Step 2: Generate Project |
| 1301 | &nbsp;&nbsp;↳ Step 3: Common Setup |
| 1600 | Output Format |
| 1602 | &nbsp;&nbsp;↳ web-app |
| 1614 | &nbsp;&nbsp;↳ mobile-app |
| 1631 | &nbsp;&nbsp;↳ automation |
| 1667 | Anti-Patterns |
| 1673 | Rules |
| 1683 | Chain (Runtime-specific) |
| 1685 | &nbsp;&nbsp;↳ Claude Code |
| 1686 | &nbsp;&nbsp;↳ Handoff Write |
| 1692 | &nbsp;&nbsp;↳ Codex CLI (future) |
